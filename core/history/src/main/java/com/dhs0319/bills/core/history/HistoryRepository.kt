package com.dhs0319.bills.core.history
...
import com.dhs0319.bills.core.model.HistoryCursor
import com.dhs0319.bills.core.model.HistoryItem
import com.dhs0319.bills.core.model.HistoryPage
import com.dhs0319.bills.core.model.HistorySearchPage
import com.dhs0319.bills.core.model.HistoryTab
        ...
        return HistoryTarget.Video(
            VideoTarget.Ugc(
                ...
                src = HISTORY_VIDEO_SRC.copy(
                    ...
                    coverHint = card.cover.blankToNull()?.httpsImageUrl()
                )
            )
        )
    }
    ...
    private fun buildPgcTarget(item: CursorItem): HistoryTarget.Video? {
        ...
        return HistoryTarget.Video(
            VideoTarget.Pgc(
                ...
                src = HISTORY_VIDEO_SRC.copy(
                    titleHint = item.title,
                    coverHint = item.cardOgv.cover.blankToNull()?.httpsImageUrl()
                )
            )
        )
    }
